...
def main():
    ...
    parser.add_argument("--dataset", default="./sm_data/dataset",
    ...
    parser.add_argument("--clips-dir", default=None,
                        ...
                        "defaults to a 'clips' folder next to it")
    ...
    clips_dir = Path(args.clips_dir) if args.clips_dir else dataset_dir / "clips"
